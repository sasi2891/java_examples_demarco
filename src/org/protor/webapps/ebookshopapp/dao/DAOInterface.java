...
import org.protor.webapps.ebookshopapp.beans.Book;
import org.protor.webapps.ebookshopapp.beans.Order;
...
public interface DAOInterface {
	 ...
	 * 
	 * Nel nostro caso il database � 'ebookshop' per la gestione di 'books' e 'orders' (vedi Java Beans associati)
	...
	/** Recupera tutti gli oggetti 'Books' dal DB in base all'autore per quantit� e prezzo crescnenti. */
	...
	/** Crea un oggetto 'Book'. Restutisce 'true' se l'operazione � andata a buon fine. */
	public boolean createBook(Book book);
	
	/** Aggiorna un oggetto 'Book' esistente. Restutisce 'true' se l'operazione � andata a buon fine.*/
	...
	/** Crea un oggetto 'Order' e restituisce il codice. Ritorna 'true' se l'operazione � andata a buon fine.*/
	public boolean createOrder(Order order);
	
	/** Aggiorna un oggetto 'Order' esistente. Restutisce 'true' se l'operazione � andata a buon fine.*/
