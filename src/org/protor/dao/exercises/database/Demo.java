package org.protor.dao.exercises.database;
import java.sql.Date;
import java.util.List;

import org.protor.dao.exercises.database.beans.Corsi;
import org.protor.dao.exercises.database.beans.Esami;
import org.protor.dao.exercises.database.beans.Studenti;
import org.protor.dao.exercises.database.dao.MySQLFactoryImplementation;
import org.protor.dao.exercises.database.enumerations.DatabaseType;
	...
	public static void main(String[] args) {
		...
		case MySQL:
			...
			System.out.println(
					...
					+ ", " + String.valueOf(studente.getCity())
			...
			studenteVittorio.setCity("Napoli");
			...
			studenteVittorio.setCity("Taormina");
